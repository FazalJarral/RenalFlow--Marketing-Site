...
drop policy if exists storage_center_branding_select on storage.objects;
...
create policy storage_center_branding_select on storage.objects for select
using (bucket_id = 'center-branding');
